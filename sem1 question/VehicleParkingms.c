...
int Rikshaw=0,Car=0,Bus=0,Bike=0,amount=0,total_veh=0,choice=0,condition=20,max_veh;
...
int main(){
   ...
   // int Rikshaw=0,Car=0,Bus=0,Bike=0,amount=0,total_veh=0,choice=0,condition=20,max_veh=20;1
